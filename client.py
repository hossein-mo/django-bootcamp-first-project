...
def create_account(request_instance):
    ...
    def get_user_input_sign_in():
        ...
        request_instance.send_socket_request(
            ...
            data= {"username": user.username, "password": user.password, "email": user.email, "phone_number": user.phone, "birth_date": user.birthdate}
        )
...
def login(inq_users):
    ...
    def get_user_input_login():
        ...
        while True:
            ...
            username_duplicates = user_login.is_valid_username_login(inq_users)
            email_duplicates = user_login.is_valid_email_login(inq_users)
            ...
            if not (username_duplicates or email_duplicates):
                ...
                while True:
                    ...
                    if user_login.is_valid_password_login(password, inq_users):
